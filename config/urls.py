...
from config.views import index, LoginView, RegisterView, CheckSameId, CheckSameEmail, ChangeMemView, confirmInfo
...
urlpatterns = [
    ...
    path('confirm-info',confirmInfo.as_view(), name='confirm-info'),
